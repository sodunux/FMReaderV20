...
#define PICC_WRITE128      0xA1         //!< write 16 byte block
...
#define PICC_REQB_APf      0x05			//!< TyprB request APf
#define PICC_SlotMarker	   0x05			//!< 高位需要和slot编号相与
#define PICC_ATTRIB		   0x1D			//!< ATTRIB的头

...
#define FM320_NRSTPD_CLR 	FM320_NRSTPD_PORT->BRR=FM320_NRSTPD
#define FM320_NRSTPD_SET	FM320_NRSTPD_PORT->BSRR=FM320_NRSTPD
...
/******************functions**************/
void FM320_mDelay(u16 ms);	//ms level delay
void FM320_uDelay(u16 us);	//us level delay
...
u8 FM320_Enter_Idle(void);
u8 FM320_ReaderA_HALT(void);
